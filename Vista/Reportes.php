...
<html lang="en">
  <head>
    <link rel="stylesheet" type="text/css" href="../CSS/Reportes.min.css">
    <link href="../CSS/Reportes.css" rel="stylesheet">
    <link rel="canonical" href="https://getbootstrap.com/docs/5.0/examples/sidebars/">
    <script src="../Js/Reportes.bundle.min.js"></script>
...
<body>
    ...
    <div class="p-3" style="width: 380px;">
        <a href="../Vista/nosotros.html" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
          <img src="../Imagenes/logo andromeda.PNG" width="300" height="60" class="LogoAndromeda" alt="" />
        </a>
        <ul class="list-unstyled ps-0">
          <li class="mb-1">
            <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#user-collapse" aria-expanded="true">
              <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg> Usuarios
            </button>
          ...
          <li class="mb-1">
            <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#asset-collapse" aria-expanded="false">
              <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg> Inventario
            </button>
          ...
          <li class="mb-1">
              <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#providers-collapse" aria-expanded="false">
                  <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"/></svg> Proveedores
              </button>
          ...
          <li class="mb-1">
            <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#profiles-collapse" aria-expanded="false">
              <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>  Perfiles
            </button>
          ...
          <li class="mb-1">
              ...
              <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>  Reportes
              </button>
              <div class="collapse" id="reports-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                  <li><a href="../Vista/Reportes.html" class="link-dark rounded">Personalizado</a></li>
                  <li><a href="../Controlador/MasivoInventario.php" class="link-dark rounded">Masivo</a></li>
                </ul>
              </div>
            </li>
          ...
          <li class="mb-1">
            ...
            <svg class="bi me-2" width="16" height="16"><use xlink:href="#tools"/></svg>  Cuenta
            </button>
    ...
    <div class="container">
        ...
        <div style="color:rgb(255, 255, 255)">
            <h1><strong>Descarga Reporte de Activos</strong></h1>
        </div>
        <br>
        <br>
        <div>
            <form class="form-inline" action="../Controlador/Generar Reporte.php" method="post" >
              ...
              <div class="form-group col-md-2">
                 ...
                 <select class="form-control" id="ingresosalida" name="ingresosalida">
                   <option value="">Seleccione</option>
